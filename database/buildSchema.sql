...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `price` DOUBLE NULL,
  `max_ingredients` INT NULL COMMENT 'Cantidad máxima de ingredientes que puede tener en una order',
  `min_ingredients` INT NULL COMMENT 'Cantidad mínima de ingredientes que puede tener en una order',
